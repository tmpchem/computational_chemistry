...
angle_params = {                   ('C' ,'CA','CA'): [ 63.0, 120.00],
('C' ,'CA','HA'): [ 35.0, 120.00], ('C' ,'CB','CB'): [ 63.0, 119.20],
('C' ,'CB','NB'): [ 70.0, 130.00], ('C' ,'CM','CM'): [ 63.0, 120.70],
('C' ,'CM','CT'): [ 70.0, 119.70], ('C' ,'CM','H4'): [ 35.0, 119.70],
('C' ,'CM','HA'): [ 35.0, 119.70], ('C' ,'CT','CT'): [ 63.0, 111.10],
('C' ,'CT','H1'): [ 50.0, 109.50], ('C' ,'CT','HC'): [ 50.0, 109.50],
('C' ,'CT','HP'): [ 50.0, 109.50], ('C' ,'CT','N' ): [ 63.0, 110.10],
('C' ,'CT','N3'): [ 80.0, 111.20], ('C' ,'N' ,'CT'): [ 50.0, 121.90],
('C' ,'N' ,'H' ): [ 30.0, 120.00], ('C' ,'N*','CM'): [ 70.0, 121.60],
('C' ,'N*','CT'): [ 70.0, 117.60], ('C' ,'N*','H' ): [ 30.0, 119.20],
('C' ,'NA','C' ): [ 70.0, 126.40], ('C' ,'NA','CA'): [ 70.0, 125.20],
('C' ,'NA','H' ): [ 30.0, 116.80], ('C' ,'NC','CA'): [ 70.0, 120.50],
('C' ,'OH','HO'): [ 35.0, 113.00], ('C*','CB','CA'): [ 63.0, 134.90],
('C*','CB','CN'): [ 63.0, 108.80], ('C*','CT','CT'): [ 63.0, 115.60],
('C*','CT','HC'): [ 50.0, 109.50], ('C*','CW','H4'): [ 35.0, 120.00],
('C*','CW','NA'): [ 70.0, 108.70], ('CA','C' ,'CA'): [ 63.0, 120.00],
('CA','C' ,'OH'): [ 70.0, 120.00], ('CA','CA','CA'): [ 63.0, 120.00],
('CA','CA','CB'): [ 63.0, 120.00], ('CA','CA','CN'): [ 63.0, 120.00],
('CA','CA','CT'): [ 70.0, 120.00], ('CA','CA','H4'): [ 35.0, 120.00],
('CA','CA','HA'): [ 35.0, 120.00], ('CA','CB','CB'): [ 63.0, 117.30],
('CA','CB','CN'): [ 63.0, 116.20], ('CA','CB','NB'): [ 70.0, 132.40],
('CA','CM','CM'): [ 63.0, 117.00], ('CA','CM','H4'): [ 35.0, 123.30],
('CA','CM','HA'): [ 35.0, 123.30], ('CA','CN','CB'): [ 63.0, 122.70],
('CA','CN','NA'): [ 70.0, 132.80], ('CA','CT','CT'): [ 63.0, 114.00],
('CA','CT','HC'): [ 50.0, 109.50], ('CA','N2','CT'): [ 50.0, 123.20],
('CA','N2','H' ): [ 35.0, 120.00], ('CA','NA','H' ): [ 30.0, 118.00],
('CA','NC','CB'): [ 70.0, 112.20], ('CA','NC','CQ'): [ 70.0, 118.60],
('CB','C' ,'NA'): [ 70.0, 111.30], ('CB','C' ,'O' ): [ 80.0, 128.80],
('CB','C*','CT'): [ 70.0, 128.60], ('CB','C*','CW'): [ 63.0, 106.40],
('CB','CA','H4'): [ 35.0, 120.00], ('CB','CA','HA'): [ 35.0, 120.00],
('CB','CA','N2'): [ 70.0, 123.50], ('CB','CA','NC'): [ 70.0, 117.30],
('CB','CB','N*'): [ 70.0, 106.20], ('CB','CB','NB'): [ 70.0, 110.40],
('CB','CB','NC'): [ 70.0, 127.70], ('CB','CN','NA'): [ 70.0, 104.40],
('CB','N*','CK'): [ 70.0, 105.40], ('CB','N*','CT'): [ 70.0, 125.80],
('CB','N*','H' ): [ 30.0, 125.80], ('CB','NB','CK'): [ 70.0, 103.80],
('CB','NC','CQ'): [ 70.0, 111.00], ('CC','CT','CT'): [ 63.0, 113.10],
('CC','CT','HC'): [ 50.0, 109.50], ('CC','CV','H4'): [ 35.0, 120.00],
('CC','CV','NB'): [ 70.0, 120.00], ('CC','CW','H4'): [ 35.0, 120.00],
('CC','CW','NA'): [ 70.0, 120.00], ('CC','NA','CR'): [ 70.0, 120.00],
('CC','NA','H' ): [ 30.0, 120.00], ('CC','NB','CR'): [ 70.0, 117.00],
('CK','N*','CT'): [ 70.0, 128.80], ('CK','N*','H' ): [ 30.0, 128.80],
('CM','C' ,'NA'): [ 70.0, 114.10], ('CM','C' ,'O' ): [ 80.0, 125.30],
('CM','CA','N2'): [ 70.0, 120.10], ('CM','CA','NC'): [ 70.0, 121.50],
('CM','CM','CT'): [ 70.0, 119.70], ('CM','CM','H4'): [ 35.0, 119.70],
('CM','CM','HA'): [ 35.0, 119.70], ('CM','CM','N*'): [ 70.0, 121.20],
('CM','CT','HC'): [ 50.0, 109.50], ('CM','N*','CT'): [ 70.0, 121.20],
('CM','N*','H' ): [ 30.0, 121.20], ('CN','CA','HA'): [ 35.0, 120.00],
('CN','NA','CW'): [ 70.0, 111.60], ('CN','NA','H' ): [ 30.0, 123.10],
('CR','NA','CW'): [ 70.0, 120.00], ('CR','NA','H' ): [ 30.0, 120.00],
('CR','NB','CV'): [ 70.0, 117.00], ('CT','C' ,'N' ): [ 70.0, 116.60],
('CT','C' ,'O' ): [ 80.0, 120.40], ('CT','C' ,'O2'): [ 70.0, 117.00],
('CT','C*','CW'): [ 70.0, 125.00], ('CT','CC','CV'): [ 70.0, 120.00],
('CT','CC','CW'): [ 70.0, 120.00], ('CT','CC','NA'): [ 70.0, 120.00],
('CT','CC','NB'): [ 70.0, 120.00], ('CT','CT','CT'): [ 40.0, 109.50],
('CT','CT','H1'): [ 50.0, 109.50], ('CT','CT','H2'): [ 50.0, 109.50],
('CT','CT','HC'): [ 50.0, 109.50], ('CT','CT','HP'): [ 50.0, 109.50],
('CT','CT','N' ): [ 80.0, 109.70], ('CT','CT','N*'): [ 50.0, 109.50],
('CT','CT','N2'): [ 80.0, 111.20], ('CT','CT','N3'): [ 80.0, 111.20],
('CT','CT','OH'): [ 50.0, 109.50], ('CT','CT','OS'): [ 50.0, 109.50],
('CT','CT','S' ): [ 50.0, 114.70], ('CT','CT','SH'): [ 50.0, 108.60],
('CT','N' ,'CT'): [ 50.0, 118.00], ('CT','N' ,'H' ): [ 30.0, 118.04],
('CT','N2','H' ): [ 35.0, 118.40], ('CT','N3','H' ): [ 50.0, 109.50],
('CT','OH','HO'): [ 55.0, 108.50], ('CT','OS','CT'): [ 60.0, 109.50],
('CT','OS','P' ): [100.0, 120.50], ('CT','S' ,'CT'): [ 62.0,  98.90],
('CT','S' ,'S' ): [ 68.0, 103.70], ('CT','SH','SH'): [ 43.0,  96.00],
('CV','CC','NA'): [ 70.0, 120.00], ('CW','CC','NA'): [ 70.0, 120.00],
('CW','CC','NB'): [ 70.0, 120.00], ('CW','NA','H' ): [ 30.0, 120.00],
('F' ,'CT','F' ): [ 77.0, 109.10], ('F' ,'CT','H1'): [ 35.0, 109.50],
('H' ,'N' ,'H' ): [ 35.0, 120.00], ('H' ,'N2','H' ): [ 35.0, 120.00],
('H' ,'N3','H' ): [ 35.0, 109.50], ('H1','CT','H1'): [ 35.0, 109.50],
('H1','CT','N' ): [ 50.0, 109.50], ('H1','CT','N*'): [ 50.0, 109.50],
('H1','CT','N2'): [ 50.0, 109.50], ('H1','CT','OH'): [ 50.0, 109.50],
('H1','CT','OS'): [ 50.0, 109.50], ('H1','CT','S' ): [ 50.0, 109.50],
('H1','CT','SH'): [ 50.0, 109.50], ('H2','CT','H2'): [ 35.0, 109.50],
('H2','CT','N*'): [ 50.0, 109.50], ('H2','CT','OS'): [ 50.0, 109.50],
('H4','CM','N*'): [ 35.0, 119.10], ('H4','CV','NB'): [ 35.0, 120.00],
('H4','CW','NA'): [ 35.0, 120.00], ('H5','CK','N*'): [ 35.0, 123.05],
('H5','CK','NB'): [ 35.0, 123.05], ('H5','CQ','NC'): [ 35.0, 115.45],
('H5','CR','NA'): [ 35.0, 120.00], ('H5','CR','NB'): [ 35.0, 120.00],
('HC','CT','HC'): [ 35.0, 109.50], ('HO','OH','P' ): [ 45.0, 108.50],
('HP','CT','HP'): [ 35.0, 109.50], ('HP','CT','N3'): [ 50.0, 109.50],
('HS','SH','HS'): [ 35.0,  92.07], ('HW','OW','HW'): [100.0, 104.52],
('N' ,'C' ,'O' ): [ 80.0, 122.90], ('N*','C' ,'NA'): [ 70.0, 115.40],
('N*','C' ,'NC'): [ 70.0, 118.60], ('N*','C' ,'O' ): [ 80.0, 120.90],
('N*','CB','NC'): [ 70.0, 126.20], ('N*','CK','NB'): [ 70.0, 113.90],
('N*','CT','OS'): [ 50.0, 109.50], ('N2','CA','N2'): [ 70.0, 120.00],
('N2','CA','NA'): [ 70.0, 116.00], ('N2','CA','NC'): [ 70.0, 119.30],
('NA','C' ,'O' ): [ 80.0, 120.60], ('NA','CA','NC'): [ 70.0, 123.30],
('NA','CR','NA'): [ 70.0, 120.00], ('NA','CR','NB'): [ 70.0, 120.00],
('NC','C' ,'O' ): [ 80.0, 122.50], ('NC','CQ','NC'): [ 70.0, 129.10],
('O' ,'C' ,'O' ): [ 80.0, 126.00], ('O2','C' ,'O2'): [ 80.0, 126.00],
('O2','P' ,'O2'): [140.0, 119.90], ('O2','P' ,'OH'): [ 45.0, 108.23],
('O2','P' ,'OS'): [100.0, 108.23], ('OH','P' ,'OS'): [ 45.0, 102.60],
('OS','P' ,'OS'): [ 45.0, 102.60], ('P' ,'OS','P' ): [100.0, 120.50]} 
...
('C*','CW'): [26.10, 180.0, 2, 4], ('CA','CA'): [14.50, 180.0, 2, 4],
('CA','CB'): [14.00, 180.0, 2, 4], ('CA','CM'): [10.20, 180.0, 2, 4],
('CA','CN'): [14.50, 180.0, 2, 4], ('CA','CT'): [ 0.00,   0.0, 2, 6],
('CA','N2'): [ 9.60, 180.0, 2, 4], ('CA','NA'): [ 6.00, 180.0, 2, 2],
('CA','NC'): [ 9.60, 180.0, 2, 2], ('CB','CB'): [21.80, 180.0, 2, 4],
('CB','CN'): [12.00, 180.0, 2, 4], ('CB','N*'): [ 6.60, 180.0, 2, 4],
('CB','NB'): [ 5.10, 180.0, 2, 2], ('CB','NC'): [ 8.30, 180.0, 2, 2],
('CC','CT'): [ 0.00,   0.0, 2, 6], ('CC','CV'): [20.60, 180.0, 2, 4],
('CC','CW'): [21.50, 180.0, 2, 4], ('CC','NA'): [ 5.60, 180.0, 2, 4],
('CC','NB'): [ 4.80, 180.0, 2, 2], ('CK','N*'): [ 6.80, 180.0, 2, 4],
('CK','NB'): [20.00, 180.0, 2, 2], ('CM','CM'): [26.60, 180.0, 2, 4],
('CM','CT'): [ 0.00,   0.0, 3, 6], ('CM','N*'): [ 7.40, 180.0, 2, 4],
('CN','NA'): [ 6.10, 180.0, 2, 4], ('CQ','NC'): [13.60, 180.0, 2, 2],
('CR','NA'): [ 9.30, 180.0, 2, 4], ('CR','NB'): [10.00, 180.0, 2, 2],
('CT','CT'): [ 1.40,   0.0, 3, 9], ('CT','N' ): [ 0.00,   0.0, 2, 6],
('CT','N*'): [ 0.00,   0.0, 2, 6], ('CT','N2'): [ 0.00,   0.0, 3, 6],
('CT','N3'): [ 1.40,   0.0, 3, 9], ('CT','OH'): [ 0.50,   0.0, 3, 3],
('CT','OS'): [ 1.15,   0.0, 3, 3], ('CT','S' ): [ 1.00,   0.0, 3, 3],
('CT','SH'): [ 0.75,   0.0, 3, 3], ('CV','NB'): [ 4.80, 180.0, 2, 2],
('CW','NA'): [ 6.00, 180.0, 2, 4], ('OH','P' ): [ 0.75,   0.0, 3, 3],
('OS','P' ): [ 4.80, 180.0, 2, 2]}
...
oop234_params = {('CT','N' ,'CT'):  1.0, ('N2','CA','N2'): 10.5,
                 ('O2','C' ,'O2'): 10.5}

# AMBER94 molecular mechanics outofplane parameters for atom type
# quartets where al 4 atom types are known (see above for parameter
# descriptions).
oop1234_params = {           ('CA','CA','C' ,'OH'):  1.1,
('CA','CA','CA','CT'):  1.1, ('CB','NC','CA','N2'):  1.1,
('CK','CB','N*','CT'):  1.0, ('CM','C' ,'CM','CT'):  1.1,
('CM','C' ,'N*','CT'):  1.0, ('CT','CM','CM','C' ):  1.1,
('CW','CB','C*','CT'):  1.1, ('NC','CM','CA','N2'):  1.1,
('NA','CV','CC','CT'):  1.1, ('NA','CW','CC','CT'):  1.1,
('NA','NC','CA','N2'):  1.1, ('NB','CW','CC','CT'):  1.1}
