...
vdw_params = {            'C' : [1.9080, 0.0860], 'CA': [1.9080, 0.0860],
  ...
  'HO': [0.0000, 0.0000], 'HP': [1.1000, 0.0157], 'HS': [0.6000, 0.0157],
  'HW': [0.0000, 0.0000], 'Li': [1.1370, 0.0183], 'IP': [1.8680, 0.00277],
...
angle_params = {             'C CACA': [ 63.0, 120.00], 'C CAHA': [ 35.0, 120.00],
  ...
  'C CTCT': [ 63.0, 111.10], 'C CTH1': [ 50.0, 109.50], 'C CTHC': [ 50.0, 109.50],
  'C CTHP': [ 50.0, 109.50], 'C CTN ': [ 63.0, 110.10], 'C CTN3': [ 80.0, 111.20],
  'C N CT': [ 50.0, 121.90], 'C N H ': [ 30.0, 120.00], 'C N*CM': [ 70.0, 121.60],
  'C N*CT': [ 70.0, 117.60], 'C N*H ': [ 30.0, 119.20], 'C NAC ': [ 70.0, 126.40],
  'C NACA': [ 70.0, 125.20], 'C NAH ': [ 30.0, 116.80], 'C NCCA': [ 70.0, 120.50],
  'C OHHO': [ 35.0, 113.00], 'C*CBCA': [ 63.0, 134.90], 'C*CBCN': [ 63.0, 108.80],
  'C*CTCT': [ 63.0, 115.60], 'C*CTHC': [ 50.0, 109.50], 'C*CWH4': [ 35.0, 120.00],
  'C*CWNA': [ 70.0, 108.70], 'CAC CA': [ 63.0, 120.00], 'CAC OH': [ 70.0, 120.00],
  'CACACA': [ 63.0, 120.00], 'CACACB': [ 63.0, 120.00], 'CACACN': [ 63.0, 120.00],
  'CACACT': [ 70.0, 120.00], 'CACAH4': [ 35.0, 120.00], 'CACAHA': [ 35.0, 120.00],
  'CACBCB': [ 63.0, 117.30], 'CACBCN': [ 63.0, 116.20], 'CACBNB': [ 70.0, 132.40],
  'CACMCM': [ 63.0, 117.00], 'CACMH4': [ 35.0, 123.30], 'CACMHA': [ 35.0, 123.30],
  'CACNCB': [ 63.0, 122.70], 'CACNNA': [ 70.0, 132.80], 'CACTCT': [ 63.0, 114.00],
  'CACTHC': [ 50.0, 109.50], 'CAN2CT': [ 50.0, 123.20], 'CAN2H ': [ 35.0, 120.00],
  'CANAH ': [ 30.0, 118.00], 'CANCCB': [ 70.0, 112.20], 'CANCCQ': [ 70.0, 118.60],
  'CBC NA': [ 70.0, 111.30], 'CBC O ': [ 80.0, 128.80], 'CBC*CT': [ 70.0, 128.60],
  'CBC*CW': [ 63.0, 106.40], 'CBCAH4': [ 35.0, 120.00], 'CBCAHA': [ 35.0, 120.00],
  'CBCAN2': [ 70.0, 123.50], 'CBCANC': [ 70.0, 117.30], 'CBCBN*': [ 70.0, 106.20],
  'CBCBNB': [ 70.0, 110.40], 'CBCBNC': [ 70.0, 127.70], 'CBCNNA': [ 70.0, 104.40],
  'CBN*CK': [ 70.0, 105.40], 'CBN*CT': [ 70.0, 125.80], 'CBN*H ': [ 30.0, 125.80],
  'CBNBCK': [ 70.0, 103.80], 'CBNCCQ': [ 70.0, 111.00], 'CCCTCT': [ 63.0, 113.10],
  'CCCTHC': [ 50.0, 109.50], 'CCCVH4': [ 35.0, 120.00], 'CCCVNB': [ 70.0, 120.00],
  'CCCWH4': [ 35.0, 120.00], 'CCCWNA': [ 70.0, 120.00], 'CCNACR': [ 70.0, 120.00],
  'CCNAH ': [ 30.0, 120.00], 'CCNBCR': [ 70.0, 117.00], 'CKN*CT': [ 70.0, 128.80],
  'CKN*H ': [ 30.0, 128.80], 'CMC NA': [ 70.0, 114.10], 'CMC O ': [ 80.0, 125.30],
  'CMCAN2': [ 70.0, 120.10], 'CMCANC': [ 70.0, 121.50], 'CMCMCT': [ 70.0, 119.70],
  'CMCMH4': [ 35.0, 119.70], 'CMCMHA': [ 35.0, 119.70], 'CMCMN*': [ 70.0, 121.20],
  'CMCTHC': [ 50.0, 109.50], 'CMN*CT': [ 70.0, 121.20], 'CMN*H ': [ 30.0, 121.20],
  'CNCAHA': [ 35.0, 120.00], 'CNNACW': [ 70.0, 111.60], 'CNNAH ': [ 30.0, 123.10],
  'CRNACW': [ 70.0, 120.00], 'CRNAH ': [ 30.0, 120.00], 'CRNBCV': [ 70.0, 117.00],
  'CTC N ': [ 70.0, 116.60], 'CTC O ': [ 80.0, 120.40], 'CTC O2': [ 70.0, 117.00],
  'CTC*CW': [ 70.0, 125.00], 'CTCCCV': [ 70.0, 120.00], 'CTCCCW': [ 70.0, 120.00],
  'CTCCNA': [ 70.0, 120.00], 'CTCCNB': [ 70.0, 120.00], 'CTCTCT': [ 40.0, 109.50],
  'CTCTH1': [ 50.0, 109.50], 'CTCTH2': [ 50.0, 109.50], 'CTCTHC': [ 50.0, 109.50],
  'CTCTHP': [ 50.0, 109.50], 'CTCTN ': [ 80.0, 109.70], 'CTCTN*': [ 50.0, 109.50],
  'CTCTN2': [ 80.0, 111.20], 'CTCTN3': [ 80.0, 111.20], 'CTCTOH': [ 50.0, 109.50],
  'CTCTOS': [ 50.0, 109.50], 'CTCTS ': [ 50.0, 114.70], 'CTCTSH': [ 50.0, 108.60],
  'CTN CT': [ 50.0, 118.00], 'CTN H ': [ 30.0, 118.04], 'CTN2H ': [ 35.0, 118.40],
  'CTN3H ': [ 50.0, 109.50], 'CTOHHO': [ 55.0, 108.50], 'CTOSCT': [ 60.0, 109.50],
  'CTOSP ': [100.0, 120.50], 'CTS CT': [ 62.0,  98.90], 'CTS S ': [ 68.0, 103.70],
  'CTSHSH': [ 43.0,  96.00], 'CVCCNA': [ 70.0, 120.00], 'CWCCNA': [ 70.0, 120.00],
  'CWCCNB': [ 70.0, 120.00], 'CWNAH ': [ 30.0, 120.00], 'F CTF ': [ 77.0, 109.10],
  'F CTH1': [ 35.0, 109.50], 'H N H ': [ 35.0, 120.00], 'H N2H ': [ 35.0, 120.00],
  'H N3H ': [ 35.0, 109.50], 'H1CTH1': [ 35.0, 109.50], 'H1CTN ': [ 50.0, 109.50],
  'H1CTN*': [ 50.0, 109.50], 'H1CTN2': [ 50.0, 109.50], 'H1CTOH': [ 50.0, 109.50],
  'H1CTOS': [ 50.0, 109.50], 'H1CTS ': [ 50.0, 109.50], 'H1CTSH': [ 50.0, 109.50],
  'H2CTH2': [ 35.0, 109.50], 'H2CTN*': [ 50.0, 109.50], 'H2CTOS': [ 50.0, 109.50],
  'H4CMN*': [ 35.0, 119.10], 'H4CVNB': [ 35.0, 120.00], 'H4CWNA': [ 35.0, 120.00],
  'H5CKN*': [ 35.0, 123.05], 'H5CKNB': [ 35.0, 123.05], 'H5CQNC': [ 35.0, 115.45],
  'H5CRNA': [ 35.0, 120.00], 'H5CRNB': [ 35.0, 120.00], 'HCCTHC': [ 35.0, 109.50],
  'HOOHP ': [ 45.0, 108.50], 'HPCTHP': [ 35.0, 109.50], 'HPCTN3': [ 50.0, 109.50],
  'HSSHHS': [ 35.0,  92.07], 'HWOWHW': [100.0, 104.52], 'N C O ': [ 80.0, 122.90],
  'N*C NA': [ 70.0, 115.40], 'N*C NC': [ 70.0, 118.60], 'N*C O ': [ 80.0, 120.90],
  'N*CBNC': [ 70.0, 126.20], 'N*CKNB': [ 70.0, 113.90], 'N*CTOS': [ 50.0, 109.50],
  'N2CAN2': [ 70.0, 120.00], 'N2CANA': [ 70.0, 116.00], 'N2CANC': [ 70.0, 119.30],
  'NAC O ': [ 80.0, 120.60], 'NACANC': [ 70.0, 123.30], 'NACRNA': [ 70.0, 120.00],
  'NACRNB': [ 70.0, 120.00], 'NCC O ': [ 80.0, 122.50], 'NCCQNC': [ 70.0, 129.10],
  'O C O ': [ 80.0, 126.00], 'O2C O2': [ 80.0, 126.00], 'O2P O2': [140.0, 119.90],
...
# 2-atom out-of-plane parameters, [Vn/2 (kcal/mol), Gamma (degrees), n (unitless)]
oop34_params = {              'C O ': [10.5, 180.0, 2.0], 'CAH4': [ 1.1, 180.0, 2.0],
  'CAH5': [ 1.1, 180.0, 2.0], 'CAHA': [ 1.1, 180.0, 2.0], 'CKH5': [ 1.1, 180.0, 2.0],
  'CMH4': [ 1.1, 180.0, 2.0], 'CMHA': [ 1.1, 180.0, 2.0], 'CQH5': [ 1.1, 180.0, 2.0],
  'CRH5': [ 1.1, 180.0, 2.0], 'CVH4': [ 1.1, 180.0, 2.0], 'CWH4': [ 1.1, 180.0, 2.0],
  'N H ': [ 1.0, 180.0, 2.0], 'N2H ': [ 1.0, 180.0, 2.0], 'NAH ': [ 1.0, 180.0, 2.0]}

# 3-atom out-of-plane parameters, [Vn/2 (kcal/mol), Gamma (degrees), n (unitless)]
oop234_params = {               'CTN CT': [ 1.0, 180.0, 2.0],
  'N2CAN2': [10.5, 180.0, 2.0], 'O2C O2': [10.5, 180.0, 2.0]}

# 4-atom out-of-plane parameters, [Vn/2 (kcal/mol), Gamma (degrees), n (unitless)]
oop1234_params = {                'CACAC OH': [ 1.1, 180.0, 2.0],
  'CACACACT': [ 1.1, 180.0, 2.0], 'CBNCCAN2': [ 1.1, 180.0, 2.0],
  'CKCBN*CT': [ 1.0, 180.0, 2.0], 'CMC CMCT': [ 1.1, 180.0, 2.0],
  'CMC N*CT': [ 1.0, 180.0, 2.0], 'CTCMCMC' : [ 1.1, 180.0, 2.0],
  'CWCBC*CT': [ 1.1, 180.0, 2.0], 'NCCMCAN2': [ 1.1, 180.0, 2.0],
  'NACVCCCT': [ 1.1, 180.0, 2.0], 'NACWCCCT': [ 1.1, 180.0, 2.0],
  'NANCCAN2': [ 1.1, 180.0, 2.0], 'NBCWCCCT': [ 1.1, 180.0, 2.0]}
