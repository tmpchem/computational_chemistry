...
POSITIVE_UNIT_X = [1.0, 0.0, 0.0]
POSITIVE_UNIT_Y = [0.0, 1.0, 0.0]
POSITIVE_UNIT_Z = [0.0, 0.0, 1.0]

NEGATIVE_UNIT_X = [-1.0,  0.0,  0.0]
NEGATIVE_UNIT_Y = [ 0.0, -1.0,  0.0]
NEGATIVE_UNIT_Z = [ 0.0,  0.0, -1.0]

POSITIVE_ARBITRARY_X = [ 5.606651, 0.0, 0.0]
NEGATIVE_ARBITRARY_X = [-6.703290, 0.0, 0.0]

POSITIVE_ARBITRARY_Y = [0.0,  7.711671, 0.0]
NEGATIVE_ARBITRARY_Y = [0.0, -4.529674, 0.0]

POSITIVE_ARBITRARY_Z = [0.0, 0.0,  2.916089]
NEGATIVE_ARBITRARY_Z = [0.0, 0.0, -9.708677]

ARBITRARY_XY1 = [ 2.836500,  5.236433,  0.000000]
ARBITRARY_XY2 = [ 8.717305, -6.188432,  0.000000]
ARBITRARY_XY3 = [-8.733996,  5.445714,  0.000000]
ARBITRARY_XY4 = [-5.084499, -1.011108,  0.000000]

ARBITRARY_UNIT_XY1 = [ 0.476296,  0.879285,  0.000000]
ARBITRARY_UNIT_XY2 = [ 0.815421, -0.578869,  0.000000]
ARBITRARY_UNIT_XY3 = [-0.848567,  0.529088,  0.000000]
ARBITRARY_UNIT_XY4 = [-0.980795, -0.195042,  0.000000]

ARBITRARY_XZ1 = [ 2.975653,  0.000000,  5.139741]
ARBITRARY_XZ2 = [ 7.726639,  0.000000, -2.505934]
ARBITRARY_XZ3 = [-7.996581,  0.000000,  2.001329]
ARBITRARY_XZ4 = [-2.788969,  0.000000, -7.492930]

ARBITRARY_UNIT_XZ1 = [ 0.501038,  0.000000,  0.865425]
ARBITRARY_UNIT_XZ2 = [ 0.951223,  0.000000, -0.308504]
ARBITRARY_UNIT_XZ3 = [-0.970080,  0.000000,  0.242785]
ARBITRARY_UNIT_XZ4 = [-0.348833,  0.000000, -0.937185]

ARBITRARY_YZ1 = [ 0.000000,  2.268236,  8.391077]
ARBITRARY_YZ2 = [ 0.000000,  1.520357, -3.379237]
ARBITRARY_YZ3 = [ 0.000000, -0.601497,  2.640605]
ARBITRARY_YZ4 = [ 0.000000, -5.658143, -0.942184]

ARBITRARY_UNIT_YZ1 = [ 0.000000,  0.260949,  0.965352]
ARBITRARY_UNIT_YZ2 = [ 0.000000,  0.410297, -0.911958]
ARBITRARY_UNIT_YZ3 = [ 0.000000, -0.222098,  0.975024]
ARBITRARY_UNIT_YZ4 = [ 0.000000, -0.986418, -0.164257]

ARBITRARY_XYZ1 = [ 3.688426,  7.267425,  5.136008]
ARBITRARY_XYZ2 = [ 2.679605,  2.861745, -6.162862]
ARBITRARY_XYZ3 = [ 4.999002, -9.340230,  0.395498]
ARBITRARY_XYZ4 = [ 9.780405, -9.433397, -0.080764]
ARBITRARY_XYZ5 = [-2.967049,  8.213730,  3.731393]
ARBITRARY_XYZ6 = [-9.652579,  6.223187, -8.962634]
ARBITRARY_XYZ7 = [-3.162726, -1.052111,  6.240231]
ARBITRARY_XYZ8 = [-4.986630, -0.831000, -9.742808]

ARBITRARY_UNIT_XYZ1 = [ 0.382886,  0.754414,  0.533157]
ARBITRARY_UNIT_XYZ2 = [ 0.366860,  0.391797, -0.843747]
ARBITRARY_UNIT_XYZ3 = [ 0.471549, -0.881051,  0.037307]
ARBITRARY_UNIT_XYZ4 = [ 0.719747, -0.694211, -0.005943]
ARBITRARY_UNIT_XYZ5 = [-0.312421,  0.864881,  0.392904]
ARBITRARY_UNIT_XYZ6 = [-0.662584,  0.427179, -0.615224]
ARBITRARY_UNIT_XYZ7 = [-0.447052, -0.148716,  0.882059]
ARBITRARY_UNIT_XYZ8 = [-0.454308, -0.075709, -0.887622]

# Output 3d Cartesian vectors.

UNIT_VECTOR_12 = [-0.08289876, -0.36203192, -0.92847223]
UNIT_VECTOR_21 = [ 0.08289876,  0.36203192,  0.92847223]

CROSS_UNIT_VECTOR_12 = [-0.84550446,  0.51870233, -0.12676282]
CROSS_UNIT_VECTOR_21 = [ 0.84550446, -0.51870233,  0.12676282]

CROSS_VECTOR_12 = [-59.48608258,  36.49373315, -8.9184937]
CROSS_VECTOR_21 = [ 59.48608258, -36.49373315,  8.9184937]

CROSS_VECTOR_XY12 = [  0.00000000,  0.00000000, -63.20107094]
CROSS_VECTOR_XZ12 = [ -0.00000000, 47.16971329,   0.00000000]
CROSS_VECTOR_YZ12 = [-20.42233967,  0.00000000,   0.00000000]
